...
func SetTitle() 
	if &filetype ==# 'sh' || &filetype ==# 'python'
		...
		call append(line(".")+1, "\# Author: QMonkey") 
		call append(line(".")+2, "\# Mail: qmkqmonkey@gmail.com") 
	...
	"	call append(line(".")+6, append("#ifndef ",toupper(expand("%"))))
	"	call append(line(".")+7, append("#define ",toupper(expand("%"))))
	"	call append(line(".")+8, "")
